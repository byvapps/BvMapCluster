...
Pod::Spec.new do |s|
  s.name             = 'BvMapCluster'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BvMapCluster.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Pataluze/BvMapCluster'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Pataluze' => 'adrian@byvapps.com' }
  s.source           = { :git => 'https://github.com/Pataluze/BvMapCluster.git', :tag => s.version.to_s }
